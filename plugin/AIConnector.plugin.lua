...
gradient.Color = ColorSequence.new({
	...
	ColorSequenceKeypoint.new(0.5, Color3.fromRGB(35, 35, 38)),
...
subtitle.Position = UDim2.new(0, 15, 0, 56)
subtitle.BackgroundTransparency = 1
subtitle.Text = "Connect to Browser"
...
divider.Position = UDim2.new(0, 15, 0, 88)
...
statusDot.Position = UDim2.new(0, 15, 0, 108)
...
status.Position = UDim2.new(0, 30, 0, 102)
...
connectButton.Size = UDim2.new(1, -40, 0, 46)
connectButton.Position = UDim2.new(0, 20, 0, 148)
connectButton.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
connectButton.TextColor3 = Color3.fromRGB(18, 18, 18)
...
buttonGradient.Parent = connectButton

local footerLabel = Instance.new("TextLabel")
footerLabel.Size = UDim2.new(1, -30, 0, 20)
footerLabel.Position = UDim2.new(0, 15, 1, -30)
footerLabel.BackgroundTransparency = 1
footerLabel.Text = "Zenith AI Connector"
footerLabel.TextColor3 = Color3.fromRGB(80, 80, 85)
